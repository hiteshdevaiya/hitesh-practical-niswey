...
return [
    ...
    */
    ...
    'ascii' => 'يجب أن يحتوي حقل :attribute على رموز وأحرف ألفبائية رقمية ذات بايت واحد فقط.',
    ...
    'email' => 'يرجى إدخال :attribute صحيح',
    ...
    'password_regex' => 'كلمة المرور لا يمكن أن تحتوي على فراغات.',
